...
const array1=[
    {
        img:"https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U2F0LCAyIFNlcA%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00352262-rhrdufwjse-portrait.jpg",
        name:"Thinking Out Loud By Manoj Prabakar",
        catagory:"Comedy | English | 12yrs + | 1hr 30mins",
        location:"Madai-Chennai",
    },
    {
        img:"https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-V2VkLCAzMCBBdWcgb253YXJkcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00307957-dtrsnjaphf-portrait.jpg",
        name:"Sunburn Arena Ft. Dimitri Vegas &Like Mike-Chennai",
        catagory:"Comedy | English | 12yrs + | 1hr 30mins",
        location:"Madai-Chennai",
    },
    {
        img:"https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-V2VkLCAzMCBBdWcgb253YXJkcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00362045-nmhplzkurs-portrait.jpg",
        name:"Barkha Ritu-Musical Celebration with the Maestro",
        catagory:"Comedy | English | 12yrs + | 1hr 30mins",
        location:"Madai-Chennai"
    },
    {
        img:"https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-V2VkLCAzMCBBdWcgb253YXJkcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00366036-mvcnfsppnc-portrait.jpg",
        name:"Kisi Ko Batana Mat Ft. Anubhav Singh Bassi",
        catagory:"Comedy | English | 12yrs + | 1hr 30mins",
        location:"Madai-Chennai"
    },
    {
        img:"https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-V2VkLCAzMCBBdWcgb253YXJkcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24:q-80/et00338006-zvxcrdlcub-portrait.jpg",
...
function Events(){
    return(
     ...
     <div className='div2nd'>
        <img src="https://assets-in.bmscdn.com/promotions/cms/creatives/1693304822085_dayoutingdesktop.jpg" alt="" />
     </div>
     <div className='div3rd'>
        <h2> Activities In Chennai </h2>
