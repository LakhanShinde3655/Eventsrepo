...
{
    MoviesData.map((index)=>{return(
        <div>
            <img style={{height:"350px",borderRadius: "20px"}}    src={index.imageLink} alt="" />
            {/* <h2 style={{height:"5px",width:"400px"}}>{index.title}</h2> */}
            <p style={{height:""}}>{index.certificate}</p>
            <p style={{height:""}}>{index.languages}</p>
        </div>
    )}) 
}
    </div>
